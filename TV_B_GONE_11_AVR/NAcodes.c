...
// const PGM_P *powerCodes[] PROGMEM  = {
 const struct powercode * const powerCodes[] PROGMEM  = { // Changed by Y.M. to avoid variable 'powerCodes' must be const error
...
uint8_t num_codes = (sizeof(powerCodes)/sizeof(*(powerCodes))); //Changed by Y.M.